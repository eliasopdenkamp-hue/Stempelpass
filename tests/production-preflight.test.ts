 ...
 *   - the exact migration set 001–015 (filesystem only) and Vercel entry
...
describe('migrationCheck (filesystem only, exact 001–015 set)', () => {
  ...
  test('extra file beyond 015 -> MIGRATIONS_INCOMPLETE', async () => {
    const root = '/proj';
    const files: Record<string, string> = {};
