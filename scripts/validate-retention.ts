...
async function insertFixtures(db: QueryConnection): Promise<void> {
  ...
  await exec(db, 'insert into customers(id, tenant_id, external_ref, deleted_at) values ($1,$2,\'active-a\',null),($3,$2,\'soft-29-a\',$4),($5,$2,\'stale-a\',$6),($7,$2,\'consent-recent-a\',null),($8,$2,\'consent-old-a\',null),($9,$2,\'consent-never-a\',null),($10,$11,\'stale-b\',$6)', [
  ...
  await exec(db, 'insert into cards(id, tenant_id, customer_id, public_token_hash, status, stamp_count, rule_id, deleted_at) values ($1,$2,$3,$4,\'inactive\',2,$5,$6),($7,$8,$9,$10,\'inactive\',0,$11,$6)', [
  ...
  await exec(db, 'insert into stamp_events(id, tenant_id, card_id, employee_membership_id, quantity, idempotency_key, created_at) values ($1,$2,$3,$4,1,\'fixture-stamp-a\',$5)', [IDS.stampA, IDS.tenantA, IDS.cardA, IDS.memberA, d31]);
  await exec(db, 'insert into rewards(id, tenant_id, card_id, rule_id, status, issued_at) values ($1,$2,$3,$4,\'issued\',$5)', [IDS.rewardA, IDS.tenantA, IDS.cardA, IDS.ruleA, d31]);
  await exec(db, 'insert into card_creation_idempotency(tenant_id, idempotency_key, request_fingerprint, card_id, token_ciphertext, created_at) values ($1,\'fixture-card-a\',\'fixture-fingerprint\',$2,\'fixture-ciphertext\',$3)', [IDS.tenantA, IDS.cardA, d31]);

  await exec(db, 'insert into communication_preferences(tenant_id, customer_id, purpose, channel, opted_in, opted_in_at, withdrawn_at) values ($1,$2,\'marketing\',\'email\',false,null,$3),($1,$4,\'marketing\',\'email\',false,null,$5),($1,$6,\'marketing\',\'email\',false,null,null),($1,$7,\'marketing\',\'email\',true,$8,$9),($1,$10,\'marketing\',\'email\',true,$8,null)', [
    IDS.tenantA, IDS.staleA, y2, IDS.consentOldA, y35, IDS.consentNeverA, IDS.consentRecentA, y2, y2, IDS.activeA,
  ]);
  await exec(db, 'insert into communication_consent_events(tenant_id, customer_id, purpose, channel, action, source, occurred_at) values ($1,$2,\'marketing\',\'email\',\'withdraw\',\'admin_action\',$3),($1,$4,\'marketing\',\'email\',\'withdraw\',\'unsubscribe_link\',$5),($1,$6,\'marketing\',\'email\',\'opt_in\',\'web_form\',$7),($1,$8,\'marketing\',\'email\',\'withdraw\',\'system\',$9)', [
    IDS.tenantA, IDS.staleA, y2, IDS.consentOldA, y35, IDS.consentNeverA, now, IDS.consentRecentA, y2,
  ]);
  await exec(db, 'insert into communication_message_logs(tenant_id, customer_id, purpose, channel, message_type, recipient_hash, status, provider_message_id, created_at) values ($1,$2,\'marketing\',\'email\',\'fixture-23-month\',$3,\'sent\',\'fixture-provider-23\',$4),($1,$2,\'marketing\',\'email\',\'fixture-25-month\',$3,\'sent\',\'fixture-provider-25\',$5),($1,$6,\'service\',\'email\',\'fixture-customer\',$3,\'sent\',\'fixture-provider-customer\',$7),($8,$9,\'service\',\'email\',\'fixture-b-25-month\',$3,\'sent\',\'fixture-provider-b\',$5)', [
    IDS.tenantA, IDS.activeA, hash('fixture-recipient'), m23, m25, IDS.staleA, now, IDS.tenantB, IDS.staleB,
  ]);
  await exec(db, 'insert into sessions(id, user_id, tenant_id, token_hash, csrf_token_hash, expires_at, revoked_at) values ($1,$2,$3,$4,$5,$6,null),($7,$2,$3,$8,$9,$10,null),($11,$2,$3,$12,$13,$14,$15),($16,$2,$3,$17,$18,$19,$20)', [
